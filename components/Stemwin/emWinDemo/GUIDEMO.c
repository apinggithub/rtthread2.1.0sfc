...
static const GUI_WIDGET_CREATE_INFO _aFrameWinDis[] = {
  { FRAMEWIN_CreateIndirect, "11111", 		1,                0, 0, 159, 127, 0,          0 },
  { BUTTON_CreateIndirect,   "pro",    		GUI_ID_BUTTON2,   10, 80, BUTTON_SIZE_X,  BUTTON_SIZE_Y,  0,  0 },
  { BUTTON_CreateIndirect,   "next",      GUI_ID_BUTTON3,   100, 80, BUTTON_SIZE_X,  BUTTON_SIZE_Y,  0, 0 }//,
  /*{ PROGBAR_CreateIndirect,  0,         GUI_ID_PROGBAR0,  2, 11, PROGBAR_SIZE_X, PROGBAR_SIZE_Y, WM_CF_HIDE, 0 },
  { TEXT_CreateIndirect,     0,         GUI_ID_TEXT0,     2,  2, TEXT_SIZE_X,    TEXT_SIZE_Y,    0,          0 }*/
};
...
/*static const GUI_WIDGET_CREATE_INFO _aFrameWinInfo[] = {
 ...
 WM_HWIN win_foucus_button[2][2]={{0,0},{0,0}};
...
char  win_foucus_button_x = 0,win_foucus_button_y = 0;
static GUIDEMO_CONFIG _GUIDemoConfig;
static WM_HWIN        _hDialogControl;
static WM_HWIN        _hDialogInfo;
static WM_HWIN        _hDialogDis;
static WM_HWIN        _win_desk_handel;
...
static void _cbFrameWinDis(WM_MESSAGE * pMsg) {
  WM_HWIN hItem;
  int     xSize;
  int     ySize;
  int     NCode;
  ...
  case WM_INIT_DIALOG:
    ...
    win_foucus_button[0][0] = hItem;
  
    BUTTON_SetFocussable(hItem, 0);
    hItem = WM_GetDialogItem(pMsg->hWin, GUI_ID_BUTTON3);
    win_foucus_button[0][1] = hItem;
    BUTTON_SetFocussable(hItem, 0);
    if(0 == win_foucus_button_x)
		BUTTON_SetFocussable(win_foucus_button[win_foucus_button_x][win_foucus_button_y], 1);
		//WM_SetFocus(hItem);
