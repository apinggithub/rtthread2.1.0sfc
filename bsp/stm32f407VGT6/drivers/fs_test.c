...
static void fsrw1_thread_entry(void* parameter)
{
    ...
    while(1)
    {
        ...
        write_speed = fsrw1_data_len*10UL*RT_TICK_PER_SECOND/(tick_end-tick_start);
        ...
        tick_end = rt_tick_get();
        read_speed = fsrw1_data_len*10UL*RT_TICK_PER_SECOND/(tick_end-tick_start);
...
static void fsrw2_thread_entry(void* parameter)
{
    ...
    while(1)
    {
        ...
        tick_end = rt_tick_get();
        write_speed = fsrw2_data_len*10UL*RT_TICK_PER_SECOND/(tick_end-tick_start);
        ...
        tick_end = rt_tick_get();
        read_speed = fsrw2_data_len*10UL*RT_TICK_PER_SECOND/(tick_end-tick_start);
